                ...
                <div class="col-md-4">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h3>{{ date('d.M Y', strtotime($event->start)) }} @lang('events.time_delimiter') {{ date('H:i', strtotime($event->start)) }} @lang('events.time_suffix')</h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h3>{{ date('d.M Y', strtotime($event->end)) }} @lang('events.time_delimiter') {{ date('H:i', strtotime($event->end)) }} @lang('events.time_suffix')</h3>
                        </div>
                    </div>
                </div>
				<div class="col-md-4">
