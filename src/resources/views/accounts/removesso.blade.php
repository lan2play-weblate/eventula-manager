                                    ...
                                    <div class="mb-3">
                                        ...
                                        @else
                                            <input type="email" class="form-control" name="emails"
                                                id="emails @error('email') is-invalid @enderror" aria-describedby="email"
                                                value="{{ $user->email }}" disabled placeholder="@lang('accounts.email')">
